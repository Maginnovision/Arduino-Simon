...
{
public:
  SoftwareWire(uint8_t sdaPin, uint8_t sclPin, boolean pullups = false, boolean detectClockStretch = true);
  SoftwareWire() {};
  ~SoftwareWire();
  void end();
  void start(uint8_t sdaPin, uint8_t sclPin, boolean pullups = false, boolean detectClockStretch = true);
  void begin();
